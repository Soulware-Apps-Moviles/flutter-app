...
class ProductRepositoryImpl implements ProductRepository {
  ...
  ProductRepositoryImpl({required ProductService productService, required FavoriteService favoriteService})
  : _productService = productService, _favoriteService = favoriteService;

@override
Future<List<Product>> fetchProducts({required int customerId, CategoryType? category, String? name}) async {
  List<Product> allProducts = await _productService.fetchProducts(category: category?.stringName, name: name);
